...
:::{note} この資料の位置づけ
ヘビ模様と反応拡散を学ぶ前の準備章である．Strogatzで学んだ2変数ODEを，空間の各点に置くところから始める．[PDE入門](./10_pde_foundations.md)で扱う場，ラプラシアン，差分法を先に学ぶと理解しやすい．
:::

## この章の目的

反応拡散方程式を，突然現れる新しい公式としてではなく，**各点で進む反応ODE**と**隣接点との拡散**を足したモデルとして読めるようにする．また，生成された模様を美しさや主観的な類似性だけで評価せず，空間パターンとして観察するための語彙を準備する．
