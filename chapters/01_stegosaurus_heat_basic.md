---
title: ステゴサウルス背板の放熱 I：熱方程式とフィンモデル
---

# 第1章　ステゴサウルス背板の放熱 I：熱方程式とフィンモデル
...
:::{note} 第1回（50分）の位置づけ
本章と[第2章](./02_stegosaurus_heat_shape.md)を学生Aが1回で担当する。0–27分で本章の温度場・境界条件・フィンモデルを説明し、27–44分で第2章の形状比較をNotebookで示す。発表前に全員が[共通準備：ODEからPDEへ](./00_pde_foundations.md)を終えていることを前提とする。
:::
...
- 背板を「2次元の板」として扱うと、本章の1次元フィンは第2章の形状比較へ拡張できる。
- 血流を内部発熱・吸熱項としてモデルに入れると（第2章の血流項）、より現実的になる。
