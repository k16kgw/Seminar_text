...
:::{note} 学習経路での位置づけ
本章は放熱テーマの基礎モデルを扱う．[共通準備：ODEからPDEへ](./10_pde_foundations.md)の後に，1次元フィンの解析解と差分解を照合する．複数形状の比較へ直接進まず，次の[単一薄板の2次元温度場](./12_stegosaurus_heat_shape.md)で数値計算の検証を学ぶ．
:::

## この章の目的

ステゴサウルスの背板を工学的な放熱フィンとして単純化し，**熱方程式・境界条件・フィン効率** を学ぶ．最終的に，1次元フィンの温度分布を数値計算し，フィン長を変えたときに放熱量がどう変わるかを評価指標として説明できるようになることを目指す．
