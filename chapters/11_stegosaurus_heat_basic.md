...
:::{note} 学習経路での位置づけ
本章は放熱テーマの「基礎モデル」である．[共通準備：ODEからPDEへ](./10_pde_foundations.md)の後に，1次元フィンの解析解と差分解を照合する．複数形状の比較へ直接進まず，次の[単一薄板の2次元温度場](./12_stegosaurus_heat_shape.md)で数値計算の検証を学ぶ．
:::
