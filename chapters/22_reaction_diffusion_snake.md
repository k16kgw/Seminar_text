...
[反応拡散の基礎](./21_reaction_diffusion_basic.md)では方程式から模様を生成した．しかし「斑点らしい」「ヘビに似ている」という見た目だけでは比較できない．本章では，模様を再現可能な数値へ変換する基礎を学ぶ．
...
![1枚の模様から面積比，連結成分数，特徴波長，方向を測る模式図．](../assets/figures/concepts/pattern_measurements.svg)

4つの測定は同じ画像を別の観点から要約する．自分の問いが「模様の量」「斑点の個数」「間隔」「向き」のどれに関係するかを先に決める．
