...
これらは[卒研ロードマップ](./33_boarding_research_roadmap.md)で学生自身が進める．
...
[卒研ロードマップ：行動ルールを比較する](./33_boarding_research_roadmap.md)では，観察から行動を定義し，ルールを1つずつ追加し，基準モデルと反復比較する手順を示す．行動別の結果は示さない．
