...
:::{note} 学習経路での位置づけ
本章は乗降テーマの「基礎モデル」である．[乗降研究の準備](./30_agent_foundations.md)で学んだ状態・近傍・競合解決を，車内とホームを持つ格子へ具体化する．代替行動をすぐに比較せず，次の[確率的シミュレーションの基礎](./32_agent_boarding_behavior.md)で反復とばらつきを扱う．
:::
...
| 移動候補，排他制御，更新順序 | 2人が同じセルを狙う例を手で追う |
...
- 具体的な行動分類と比較は[卒研ロードマップ](./33_boarding_research_roadmap.md)から学生自身が進める．
