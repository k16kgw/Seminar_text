...
:::{note} この資料の位置づけ
電車乗降のマルチエージェントモデルを学ぶ前の準備章である．微分方程式とは異なり，離散的な状態を規則によって更新する考え方を，少人数の手計算から身につける．ここでは実際の乗降行動の優劣はまだ比較しない．
:::
...
最大ステップ数をそのまま完了時間として記録すると，正常終了と失敗を混同する．打切り率やデッドロック率も結果として残す．
